  ...
  return (
    <div name='home' className='bg-[#0a192f] w-full h-screen'>
        ...
        <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
            ...
            <div>
                <button className='text-white border-2 group px-6 py-3 my-2 rounded-lg flex items-center hover:bg-pink-600 hover:border-pink-600'><Link to='work' smooth={true} duration={500} className='cursor-pointer'>View Work</Link>
